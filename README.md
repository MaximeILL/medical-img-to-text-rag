...
<img src="/results_examples/lung.png" alt="Example 1: lungs" width="700" height="auto" />
<img src="/results_examples/pa_liver_rag.png" alt="Example 2: pancreas and liver" width="700" height="auto" />

Some comparisons with LLaVa-1.6-Mistral-7B model : 

<img src="/results_examples/br_f.png" alt="Example 3: brain subarachnoid hemorrhage" width="700" height="auto" />
<img src="/results_examples/sp_f.png" alt="Example 4: spleen" width="700" height="auto" />

## Data

### PAD-UFES-20

The first dataset we used is a dermatological dataset containing skin lesion images with associated tabular metadata. The dataset includes 26 features covering patient medical history, clinical diagnosis, and lesion characteristics.
